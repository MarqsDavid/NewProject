                        ...
                        <table class="table table-striped table-hover">
                            ...
                            <tbody>
                                ...
                                while ($user_data = mysqli_fetch_assoc($result)) {
                                    ...
                                    echo "<td>";
                                    echo "<button class='edit' btn btn-primary' data-toggle='modal' data-target='#changeModal' data-id='{$user_data['id']}'>";
                                    ...
                                    echo "</svg>";
                                    echo "</button>";
                                    echo "<a href='#deleteEmployeeModal' class='delete' data-toggle='modal' title='Written-off assets'>";
                    ...
                    <div class="modal-body">
                        <form action="../php/saveAssests.php" method="POST">
                            ...
                            <div class="form-group">
                                ...
                                <textarea name="responsible-change" id="responsible-change" class="form-control" required></textarea>
                            </div>
                            <div class="form-group">
...
<script>
    $(document).ready(function() {
        $('.edit').click(function() {
            ...
            // Define o ID do item no campo oculto do modal
            $('#item_id').val(item_id);
        });
    });
</script>
