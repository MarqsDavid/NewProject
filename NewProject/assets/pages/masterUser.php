    ...
    <div class="container">
        <div class="table-wrapper">
            <div class="table-title">
                <div class="row">
                    ...
                    <div class="col-sm-6">
                        ...
                        <a href="../php/exitMaster.php" class="btn btn-primary"><span><svg width="14" height="14"
            ...
            <table class="table table-striped table-hover">
                ...
                <form method="post" action="../php/checkboxAdmin.php">
                    <?php
                    ...
                    ?>
                    <a  data-toggle='modal' data-target='#delete' class="btn btn-danger">Delete Selected</a>
                        ...
                        <div class="modal-content">
                            <form method="POST" action="">
                                ...
                                <div class="modal-footer">
                                    ...
                                    <input type="submit" name="submit" class="btn btn-danger btn-ok" value="Delete">
                                </div>
                            </form>
                        </div>
                    </div>
                    ...
                    <div class="modal-body">
                        ...
                        <div class="form-group">
                            ...
                            <input type="password" class="form-control" name="passwordUsers"
                                placeholder="Type the password" required></textarea>
                        </div>
                        <div class="form-group">
                            <label>Phone</label>
                            <input type="number" name="phone" class="form-control" placeholder="(xx) xxxx-xxxx"
                                required>
                        </div>
                        <div class="form-group">
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                <form method="POST" action="../php/alterUsers.php">
                    ...
                    <input type="hidden" id="user-edit" name="id-user">
                    <div class="modal-body">
                        <div class="form-group">
                        ...
                        <div class="form-group">
                            <label>Password</label>
                            <input type="password" name="alterPasswordUsers" class="form-control"
                                placeholder="Type the password" value="" required></textarea>
                        </div>
                        <div class="form-group">
                            <label>Phone</label>
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                <form method="POST" action="../php/deleteUsers.php">
                    <input type="hidden" id="user-delete" name="id">
                    <div class="modal-header">
                        <h4 class="modal-title">Delete Employee</h4>
                        <button type="button" class="close" data-dismiss="modal" aria-hidden="true">&times;</button>
                    </div>
