...
// Title of the report
$pdf->Cell(0, 10, 'Output reports', 0, 1, 'C');
...
if ($result->num_rows > 0) {
    ...
    // No results message
    $pdf->Cell(0, 10, 'No Output found.', 1, 1, 'C');
}
...
// Output the PDF (force download as 'Output_Reports.pdf')
$pdf->Output('Output_Reports.pdf', 'D');
?>
